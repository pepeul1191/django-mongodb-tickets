...
from .views.enterprises_views import enterprises_list, create_enterprise, update_enterprise, delete_enterprise, employees_enterprise, assets_enterprise
...
urlpatterns = [
  ...
  # locations - provinces
  path('locations/<str:department_id>/provinces/', locations_provinces, name='locations_provinces'),
  ...
  # locations - districts
  path('locations/<str:department_id>/provinces/<str:province_id>/districts', locations_districts, name='locations_districts'),
  path('locations/<str:department_id>/provinces/<str:province_id>/districts/add', districts_add, name='districts_add'),
  path('locations/<str:department_id>/provinces/<str:province_id>/districts/<str:district_id>/edit', districts_edit, name='districts_edit'),
  ...
  path('enterprises/<str:enterprise_id>/employees', employees_enterprise, name='employees_enterprise'),
